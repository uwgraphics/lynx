...
fn main() -> Result<(), String> {
    ...
    let mut collision_checker = RobotCollisionChecker::new_from_robot_configuration_module(&robot_configuration_module, None, Some("hubo_over_boxes".to_string()));
    ...
    let q_goal = vec_to_dvec(&vec![ -2.5, 0.,0.61261,0.,-1.2,0.,0.,0.,0.,-0.61261,0.,-1.2,0.,0.,0.]);
