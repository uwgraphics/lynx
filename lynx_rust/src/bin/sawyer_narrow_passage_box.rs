...
fn main() -> Result<(), String> {
    ...
    let mut collision_checker = RobotCollisionChecker::new_from_robot_configuration_module(&robot_configuration_module, None, Some("sawyer_narrow_passage_box".to_string()));
    ...
    let q_goal = vec_to_dvec(&vec![2.5, 0.0, -0.57308, 0.383761, 2.25104, -2.9299, 1.70881, 2.84394]);
