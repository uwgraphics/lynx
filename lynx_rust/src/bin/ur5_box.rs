...
fn main() -> Result<(), String> {
    ...
    let mut collision_checker = RobotCollisionChecker::new("ur5".to_string(), None, None, Some("ur5_single_box".to_string()));
    ...
    let q_goal = vec_to_dvec(&vec![ 0.0, -0.38, -1.2, -1.57, -1.57, -1.57 ]);
