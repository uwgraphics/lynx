...
pub fn decompose_all_links_into_convex_subcomponents_and_save_mesh_files(robot_name: String, max_compoenents_per_link: usize) -> Result<(), String> {
    ...
    for i in 0..l {
        ...
        if has_collision {
            ...
            if has_mesh_file {
                ...
                _decompose_trimesh_into_convex_subcomponents_and_save_mesh_files(links[i].name.clone(), &trimesh, out_fp.clone(), max_compoenents_per_link);
                decomposed = true;
            }
        }
...
pub fn save_all_links_as_triangle_meshes(robot_name: String) -> Result<(), String> {
    ...
    delete_directory_all_relative_to_robot_directory(robot_name.clone(), "autogenerated_metadata/link_triangle_meshes/".to_string());
    create_directories_recursively_relative_to_robot_directory(robot_name.clone(), "autogenerated_metadata/link_triangle_meshes".to_string());
    ...
    for i in 0..l {
        ...
        if has_collision {
            ...
            if has_mesh_file {
                ...
                let out_stl_fp = get_path_to_particular_robot_directory(robot_name.clone()) + "/autogenerated_metadata/link_triangle_meshes/" + links[i].name.as_str() + ".stl";
                trimesh.output_to_stl(out_stl_fp);
                let out_obj_fp = get_path_to_particular_robot_directory(robot_name.clone()) + "/autogenerated_metadata/link_triangle_meshes/" + links[i].name.as_str() + ".obj";
