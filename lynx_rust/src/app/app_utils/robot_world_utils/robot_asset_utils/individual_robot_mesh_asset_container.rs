    ...
    pub fn new(robot_name: &String, asset_server: &Res<AssetServer>) -> Self {
        ...
        for l in &robot.get_configuration_module_ref().robot_model_module.links {
            ...
            if check_if_path_exists(visual_link_path.to_string()) {
                ...
                _link_selectable_mesh_handle_ids.push( Some(h.id) );
                ...
                if check_if_path_exists(collision_link_path.to_string()) {
                    ...
                    _link_selectable_mesh_handle_ids.push(None);
        ...
        return Self { _robot_name: robot_name.clone(), _link_selectable_mesh_handle_ids, _link_wireframe_mesh_handle_ids, _link_visible_glb_scene_handle_ids };
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////

    pub fn get_link_selectable_mesh_handle_ids_ref(&self) -> &Vec<Option<HandleId>> { return &self._link_selectable_mesh_handle_ids }
